...
im1 = im2double(imread('/data/ggy/code/PFN2_MultiPerson/pycaffe_datalayer/tmp/img0.jpg'));
im2 = im2double(imread('/data/ggy/code/PFN2_MultiPerson/pycaffe_datalayer/tmp/img1.jpg'));
...
imwrite(imflow,[example '_optical_flow.jpg'])

figure(3);
imshow(imflow);
imwrite(imflow,fullfile('output',[example '_optical_flow.jpg']),'quality',100);
